...
`verify_depth_sensitivity_theorem.py` is an independent executable check based on the equations printed in the authoritative manuscript and supplement. It checks monotonicity, the condition-number identity, the stated bounds, and consecutive-difference identities.
